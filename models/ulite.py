"""
U-Lite: Lightweight U-Net Architecture
Uses axial depthwise convolutions for efficient feature extraction
"""
...
class ConfigurableULite(nn.Module):
    """
    Configurable U-Lite for hyperparameter optimization
